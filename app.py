...
def _parse_params(data: dict) -> SimulationParams:
    """
    Construit un SimulationParams depuis un dictionnaire JSON.

    La validation est déléguée au constructeur de SimulationParams.

    Args:
        data : Corps de la requête JSON.

    Returns:
        Instance de SimulationParams validée.

    Raises:
        KeyError   : Champ manquant dans le JSON.
        ValueError : Conversion de type impossible.
    """
